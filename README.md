...
[controller protocol](docs/controller-heartbeat.md). Its prompt is generated by
the release-bound automation snapshot command; do not hand-edit it or point it
at runtime scripts, legacy War Room paths, or a ledger file.
