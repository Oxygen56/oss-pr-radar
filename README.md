...
separate heartbeat that runs at 09:00 in the same durable controller thread.
Both prompts are generated by the release-bound automation snapshot command;
do not hand-edit them or point them at runtime scripts, legacy War Room paths,
or a ledger file.
