#!/usr/bin/env python3
"""Import an open-PR snapshot into a managed Ledger database copy."""
...
from oss_pr_radar.managed_lifecycle import import_open_pr_observations  # noqa: E402
...
def main() -> int:
    ...
    result = import_open_pr_observations(
        args.db_copy,
        observations,
